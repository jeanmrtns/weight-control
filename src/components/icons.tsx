...
export function ScaleIcon({ className }: { className?: string }) {
  return (
    <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round" className={cn(iconClass, className)}>
      <path d="m16 16 3-8 3 8c.87.65 1.92 1 3 1a2 2 0 0 0 0-4h-3" />
      <path d="m2 16 3-8 3 8c.87.65 1.92 1 3 1a2 2 0 0 0 0-4H5" />
      <path d="M7 21a2 2 0 0 0 2-2v-1" />
      <path d="M12 21v-4" />
      <path d="M12 17v-4" />
      <path d="M7 5v1" />
      <path d="M12 3v4" />
